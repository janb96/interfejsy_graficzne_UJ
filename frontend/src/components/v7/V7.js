            ...
            <div id="root">
                ...
                <div id="dol75">
                    <div className="container">
                        ...
                        <div className="row">
                            <div className="col-6">
                                <button type="button" onClick={this.payout50} className="btn btn-secondary btn-lg btn-block"><h1>50 zł</h1></button>
                            </div>
                            <div className="col-6">
                                <button type="button" onClick={this.payout100} className="btn btn-secondary btn-lg btn-block"><h1>100 zł</h1></button>
                            </div>
                        </div>
                        <br/>
                        <div className="row">
                            <div className="col-6">
                                <button type="button" onClick={this.payout200} className="btn btn-secondary btn-lg btn-block"><h1>200 zł</h1></button>
                            </div>
                            <div className="col-6">
                                <button type="button" onClick={this.payout500} className="btn btn-secondary btn-lg btn-block"><h1>500 zł</h1></button>
                            </div>
                        </div>
                        <br/>
                        <div className="row">
